  ...
  primer/.style={fill=white, align=left}
    ...
    \node[primer] (arch) {\textbf{EMP}};
      ...
      \node[rack, below=of labels] (rack1) {
        \begin{tikzpicture}
          \node [racknum] (1)  {\#?~};
          \node [well, right=of 1] (well1)  {\smp{+ CTRL BACT}};
          \node [well, right=of well1] (well2)  {\smp{+ CTRL BACT2}};
          \node [well, right=of well2] (well3)  {\smp{+ CTRL ARCH}};
          ...
          \node [well, right=of well7] (well8)  {\smp{- CTRL}};
        \end{tikzpicture}
      };
\end{tikzpicture}
}
