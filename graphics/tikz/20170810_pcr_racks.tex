    ...
    \node[primer] (arch) {\textbf{EMP}};
      ...
      \node[rack, below=of labels] (rack1) {
        \begin{tikzpicture}
          ...
          \node [well, right=of well1] (well2)  {\smp{+ CTRL ARCH}};
          \node [well, right=of well2] (well3)  {\smp{OSD.H0.DNA}};
          \node [well, right=of well3] (well4)  {\smp{OSD.CTRL.DNA}};
          \node [well, right=of well4] (well5)  {\smp{NEGATIVE CTRL}};
