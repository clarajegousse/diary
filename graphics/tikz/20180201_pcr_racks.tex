    ...
    \node[primer] (emp) {\textbf{EMP}};
      ...
      \node[rack, below=of labels1] (rack1) {
        \begin{tikzpicture}
          ...
          \node [well, right=of well3] (well4)  {\smp{A}};
          \node [well, right=of well4] (well5)  {\smp{B1}};
          \node [well, right=of well5] (well6)  {\smp{B2}};
          \node [well, right=of well6] (well7)  {\smp{C}};
          \node [well, right=of well7] (well8)  {\smp{D}};
        \end{tikzpicture}
      };
