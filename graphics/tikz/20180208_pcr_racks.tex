    ...
    \node[primer] (emp) {\textbf{EMP}};
      ...
      \node[rack, below=of labels1] (rack1) {
        \begin{tikzpicture}
          ...
          \node [well, right=of well3] (well4)  {\smp{DNA MP}};
          \node [well, right=of well4] (well5)  {\smp{DNA AP}};
          \node [well, right=of well5] (well6)  {\smp{1/2 DNA MP}};
          \node [well, right=of well6] (well7)  {\smp{1/2 DNA AP}};
