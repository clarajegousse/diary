...
Previously I extracted DNA and RNA from micro-algae cultures two different kits: the MasterPure\texttrademark~ by Epicentre and the AllPrep DNA/RNA Mini Kit by Qiagen.\sidenote{AllPrep DNA/RNA Mini Kit \texttt{LOT\# 148043425}.}
...
\comment{I have 2 samples, 3 controls, and 2 extra, which means I must prepare a master mix for 7 reactions.}
...
\comment{I transfer 20~\uL of Master Mix and add 5~\uL of DNA template. At that moment, I just check if there is enough master mix for two extra reactions and since there is enough, I decide to add two extra reactions in which I will only add 2.5~\uL of DNA template and complete with an extr 2.5~\uL. I do this because last time with Mia we had troubles amplifying DNA that had a lot of contaminants, and reducing the concentrations of DNA template lead us to successful PCR.}
...
\input{graphics/tikz/20180208_pcr_racks.tex}
\end{figure}
